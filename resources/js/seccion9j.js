...
document.getElementById("myForm").addEventListener("submit", (event) => {
    ...
    const url = route("seccion9j-store");
    ...
    fetch(url, requestOptions)
        ...
        let nombreVista = view[28].nombre_vista_actual;
    ...
    window.location.href = route('seccion9k-create');
});
