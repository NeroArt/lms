...
document.getElementById("myForm").addEventListener("submit", (event) => {
    ...
    const url = route("seccion9c-store");
    ...
    fetch(url, requestOptions)
        ...
        let nombreVista = view[21].nombre_vista_actual;
    ...
    window.location.href = route('seccion9d-create');
});
