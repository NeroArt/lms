...
document.getElementById("myForm").addEventListener("submit", (event) => {
    ...
    const url = route("seccion9f-store");
    ...
    fetch(url, requestOptions)
        ...
        let nombreVista = view[24].nombre_vista_actual;
    ...
    window.location.href = route('seccion9g-create');
});
