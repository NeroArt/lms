                    ...
                    <form action="{{url('/actividades')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <div class="name ">Actividad</div>
                                <div class="input-group wrap-input100 validate-input" >
                                    <input id="actividad" class="form-control" type="text" name="actividad"  required autofocus autocomplete="Actividades">
                        ...
                        <div class="mb-3">
                            <div class="name ">Porcentaje de Actividad</div>
                                <div class="input-group wrap-input100 validate-input" >
                                    <input id="porcentaje_actividad" class="form-control" type="number" name="porcentaje_actividad" required autofocus autocomplete="Porcentaje">
                                    <span class="focus-input100 "></span>
                            <span class="symbol-input100">
                                <i class="fa fa-envelope"></i>
                            </span>
