...
@vite(['resources/js/seccion8e.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 8E</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label for="cursos_id3d">5.	El instructor aplicará la técnica diálogo-discusión: </label>
                            ...
                            <a href="{{url('/seccion8f/create')}}" class="btn btn-success">Siguiente</a>
                        </div>
                    </div>
