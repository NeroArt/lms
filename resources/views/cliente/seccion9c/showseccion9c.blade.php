    ...
    @endif
        <div class="col-md-8">
            <div class="card card-5">
                <div class="card-header">Gestión de Cierre de Curso - Sección 9C</div>
                <div class="card-body">
                    <div>
                ...
                <table class="table table-bordered table-hover" >
                    ...
                    <tbody>
                        @foreach ($cierre_cursos as $cierre)
                            ...
                            <tr> 
                                <td>
                                    <a class="btn btn-warning" href="{{url('/seccion9c/'.$cierre->id.'/edit')}}">Editar
                                    </a> 
                                </td>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            @foreach ($cierre_actividades as $actividad)
                                ...
                                <tr> 
                                    <td>
                                        <a class="btn btn-warning" href="{{url('/seccion9cactividad/'.$actividad->id.'/edit')}}">Editar
                                        </a> 
                                    </td>
