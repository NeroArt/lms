    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h1>Sección número 6 PREVIO AL INICIO DEL CURSO</h1>
                <h2>COMPROBACIÓN DE LA EXISTENCIA Y EL FUNCIONAMIENTO DE LOS RECURSOS REQUERIDOS PARA EL CURSO/SESIÓN</h2>
                <!-- Parte 1 -->
                <!-- titulo -->
                <h2>Etapa:</h2>
                <!-- Tarjeta de Video -->
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Etapa:</label>
