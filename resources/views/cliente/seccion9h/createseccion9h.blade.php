...
@vite(['resources/js/seccion9h.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 9H</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label for="cursos_id3d">El instructor aplicará la evaluación de satisfacción:</label>
                            ...
                            <a href="{{url('/seccion9i/create')}}" class="btn btn-success">Siguiente</a>
                        </div>
                    </div>
