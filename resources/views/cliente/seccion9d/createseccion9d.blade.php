...
@vite(['resources/js/seccion9d.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 9D</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label for="cursos_id3d">El instructor preguntará a los participantes acerca del logro de los objetivos:</label>
                            ...
                            <div class="row">
                                <form action="" id="myForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="divDescripcionCurso" class="mb-3"></div>
                                        <div class="mb-3">
                                            <div class="name">Redactar el logro de expectativas del Curso:</div>
                                            <div class="input-group wrap-input100 validate-input" >
                                                <textarea id="actividad" class="form-control" type="text" name="actividad" autocomplete="actividad" required placeholder="Ejemplo: Los instructores junto con los participantes discuten sobre el logro y cumplimiento de los objetivos."></textarea>
                                                <span class="focus-input100 "></span>
                                                <span class="symbol-input100">
                                                <i class="fa fa-envelope"></i>
                                                </span>
                            ...
                            <a href="{{url('/seccion9e/create')}}" class="btn btn-success">Siguiente</a>
                        </div>
                    </div>
