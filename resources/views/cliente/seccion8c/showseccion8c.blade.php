    ...
    @endif
        <div class="col-md-8">
            <div class="card card-5">
                <div class="card-header">Gestión de Desarrollo de Curso - Sección 8C</div>
                <div class="card-body">
                    <div>
                ...
                <table class="table table-bordered table-hover" >
                    ...
                    <tbody>
                        @foreach ($desarrollo_cursos as $desarrollo)
                            ...
                            <tr> 
                                <td>
                                    <a class="btn btn-warning" href="{{url('/seccion8c/'.$desarrollo->id.'/edit')}}">Editar
                                    </a> 
                                </td>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            @foreach ($desarrollo_actividades as $actividad)
                                ...
                                <tr> 
                                    <td>
                                        <a class="btn btn-warning" href="{{url('/seccion8cactividad/'.$actividad->id.'/edit')}}">Editar
                                        </a> 
                                    </td>
