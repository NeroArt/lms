...
@vite(['resources/js/seccion8c.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 8C</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label for="cursos_id3d">3.	El instructor realizará la evaluación formativa:</label>
                            ...
                            <a href="{{url('/seccion8d/create')}}" class="btn btn-success">Siguiente</a>
                        </div>
                    </div>
