...
@vite(['resources/js/seccion9i.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 9I</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            <div class="row">
                                <label for="">Evidencia fotográfica con todos los participantes del curso. </label>
                                <form action="" id="myForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group wrap-input100 validate-input" >
                                            <textarea id="actividad" class="form-control" type="text" name="actividad" autocomplete="actividad" required placeholder="Ejemplo: El instructor juntara a todos los participantes y tomara una fotografia como evidencia"></textarea>
                                                <span class="focus-input100 "></span>
                                            <span class="symbol-input100">
                                                <i class="fa fa-envelope"></i>
                                            </span>
                            ...
                            <a href="{{url('/seccion9j/create')}}" class="btn btn-success">Siguiente</a>
                        </div>
                    </div>
