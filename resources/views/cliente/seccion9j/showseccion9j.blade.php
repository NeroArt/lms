    ...
    @endif
        <div class="col-md-8">
            <div class="card card-5">
                <div class="card-header">Gestión de Cierre de Curso - Sección 9J</div>
                <div class="card-body">
                ...
                <table class="table table-bordered table-hover" >
                    ...
                    <tbody>
                        @foreach ($cierre_cursos as $cierre)
                            ...
                            <tr> 
                                <td>
                                    <a class="btn btn-warning" href="{{url('/seccion9j/'.$cierre->id.'/edit')}}">Editar
                                    </a> 
                                </td>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            @foreach ($cierre_actividades as $actividad)
                                ...
                                <tr> 
                                    <td>
                                        <a class="btn btn-warning" href="{{url('/seccion9jactividad/'.$actividad->id.'/edit')}}">Editar
                                        </a> 
                                    </td>
