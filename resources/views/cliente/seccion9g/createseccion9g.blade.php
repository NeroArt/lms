...
@vite(['resources/js/seccion9g.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 9G</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            <div class="row">
                                <label for="">El instructor conducirá al grupo a la formulación de compromisos de aplicación del aprendizaje: </label>
                                <form action="" id="myForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group wrap-input100 validate-input" >
                                            <textarea id="actividad" class="form-control" type="text" name="actividad" autocomplete="actividad" required placeholder="Ejemplo: El instructor conducirá al grupo a la formulación de compromisos de aplicación del aprendizaje"></textarea>
                                                <span class="focus-input100 "></span>
                                            <span class="symbol-input100">
                                                <i class="fa fa-envelope"></i>
                                            </span>
                                    ...
                                    <div>
                                        <label for="">Redactar 2 preguntas. </label>
                            ...
                            <a href="{{url('/seccion9h/create')}}" class="btn btn-success">Siguiente</a>
                        </div>
                    </div>
