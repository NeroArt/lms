        ...
        <div class="col-md-8">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col">
                            <a href="{{url('/seccion3/'.$curso_id)}}" class="btn btn-danger">Regresar</a>
                            <span id="mySIdenavIcon">&#9776; Secciones</span>
                        </div>
                    </div>
                    
                    <form action="{{url('/seccion3/'.$objetivo->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('PATCH')}}
                        
                        <input name="tipo_objetivo" type="text" class="form-control" id="tipo_objetivo" value="particular" hidden>
                        <!-- Objetivo General: -->
                        <div class="container mt-5">
                            <div>
                                <h2>Objetivo Particular:</h2>
                            </div>

                        </div>
                        <div class="mb-3">
                            <div class="name ">Objetivo Particular</div>
