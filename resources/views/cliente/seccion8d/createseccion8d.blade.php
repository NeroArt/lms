...
@vite(['resources/js/seccion8d.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 8D</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label for="cursos_id3d">4.	El instructor aplicará una Técnica Energizante </label>
                            ...
                            <a href="{{url('/seccion8e/create')}}" class="btn btn-success">Siguiente</a>
                        </div>
                    </div>
