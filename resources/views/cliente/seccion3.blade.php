    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h1>Sección número 3 Beneficios del curso</h1>
                <!-- Parte 1 -->
                <!-- titulo -->
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Objetivos particulares:</label>
                ...
                <!-- Parte 2 -->
                <!-- titulo -->
                <h2>Sujeto: El participante</h2>
                <h2>Acción o comportamiento:</h2>
                <!-- Tarjeta de Video -->
                <div class="container mt-5">
                    <div class="card" style="width: 18rem;">
                        <div class="embed-responsive embed-responsive-16by9">
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Acción o comportamiento:</label>
                        <input type="name" class="form-control" id="exampleInputName">
                        <br>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Condición de operación:</label>
                        <input type="name" class="form-control" id="exampleInputName">
                        <br>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Temas:</label>
                        <input type="name" class="form-control" id="exampleInputName">
                        <br>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Beneficio:</label>
                        <input type="name" class="form-control" id="exampleInputName">
                        <br>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
