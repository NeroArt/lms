...
@vite(['resources/js/seccion9b.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 9B</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label for="cursos_id3d">El instructor mencionará el resumen general del curso, invitando a los participantes a resumir los contenidos: </label>
                            ...
                            <div class="row">
                                <form action="" id="myForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <div class="name">Redactar el resumen del Curso:</div>
                                            <div class="input-group wrap-input100 validate-input" >
