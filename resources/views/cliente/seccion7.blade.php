    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h1>Sección número 7 INICIO DEL CURSO</h1>
                <!-- Parte 1 -->
                <!-- titulo -->
                <h2>Etapa del Encuadre:</h2>
                <!-- Tarjeta de Video -->
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Etapa del Encuadre:</label>
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Actividades:</label>
                        <input type="name" class="form-control" id="exampleInputName">
                        <br>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Duración:</label>
                        <input type="name" class="form-control" id="exampleInputName">
                        <br>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                ...
                <!-- Parte 4 -->
                <!-- titulo -->
                <h2>Técnicas Grupales/Instruccionales:</h2>
                <!-- Tarjeta de Video -->
                <div class="container mt-5">
                    <div class="card" style="width: 18rem;">
                        <div class="embed-responsive embed-responsive-16by9">
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Técnicas Grupales/Instruccionales:</label>
                        <input type="name" class="form-control" id="exampleInputName">
                        <br>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                ...
                <!-- Parte 5 -->
                <!-- titulo -->
                <h2>Material y Equipo de Apoyo:</h2>
                <!-- Tarjeta de Video -->
                <div class="container mt-5">
                    <div class="card" style="width: 18rem;">
                        <div class="embed-responsive embed-responsive-16by9">
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputNombre" class="form-label">Material y Equipo de Apoyo:</label>
                        <input type="name" class="form-control" id="exampleInputName">
                        <br>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
