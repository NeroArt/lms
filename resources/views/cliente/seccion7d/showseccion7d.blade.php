    ...
    @endif
        <div class="col-md-8">
            <div class="card card-5">
                <div class="card-header">Gestión de Apertura o Encuadre de Curso - Sección 7D</div>
                <div class="card-body">
                    <div>
                ...
                <table class="table table-bordered table-hover" >
                    ...
                    <tbody>
                        @foreach ($inicio_cursos as $inicio)
                            ...
                            <tr> 
                                <td>
                                    <a class="btn btn-warning" href="{{url('/seccion7d/'.$inicio->id.'/edit')}}">Editar
                                    </a> 
                                </td>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            @foreach ($inicio_actividades as $actividad)
                                ...
                                <tr> 
                                    <td>
                                        <a class="btn btn-warning" href="{{url('/seccion7dactividad/'.$actividad->id.'/edit')}}">Editar
                                        </a> 
                                    </td>
