...
@vite(['resources/js/seccion8a.js'])
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-5">
                <div class="card-header">Creación de curso - Sección 8A</div>
                <div class="card-body">
                    <div class="card">
                        <div class="card-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label for="cursos_id3d">1.	El instructor aplicará la técnica expositiva:</label>
                            ...
                            <a href="{{url('/seccion8b/create')}}" class="btn btn-success">Siguiente</a>
                        </div>
                    </div>
