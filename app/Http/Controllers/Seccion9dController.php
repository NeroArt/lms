...
class Seccion9dController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cliente.seccion9d.indexseccion9d')->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }

    public function create()
    {
        return view('cliente.seccion9d.createseccion9d');
    }
    ...
    public function show($cursoId)
    {
        ...
        return view('cliente.seccion9d.showseccion9d',['cursoId' => $cursoId])->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion9d.editseccion9d',compact('cierre_curso', 'curso_id'));
    }
    ...
    { 
        ...
        ->where('cierre_cursos.seccion_encuadre', '=', 4)
        ->select('cierre_cursos.id')
        ->get();
    ...
    public function editactividad($id)
    {
        ...
        $curso_id = $cierre_curso->cursos_id; // Accede al id del curso
        return view('cliente.seccion9d.actividad',compact('cierre_actividad', 'curso_id'));
    }
