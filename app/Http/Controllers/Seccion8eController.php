...
class Seccion8eController extends Controller
{
    ...
    public function show($cursoId)
    {
        ...
        return view('cliente.seccion8e.showseccion8e')->with('desarrollo_actividades',$desarrollo_actividades)
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion8e.editseccion8e',compact('desarrollo_curso'));
    }
    ...
    public function editactividad($id)
    {
        ...
        return view('cliente.seccion8e.actividad',compact('desarrollo_actividad'));
    }
