...
class Seccion8cController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cliente.seccion8c.indexseccion8c')->with('desarrollo_actividades',$desarrollo_actividades)
        ->with('desarrollo_cursos',$desarrollo_cursos);
    }

    public function create()
    {
        return view('cliente.seccion8c.createseccion8c');
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion8c.editseccion8c',compact('desarrollo_curso', 'curso_id'));
    }
    ...
    { 
        ...
        ->where('desarrollo_cursos.seccion_encuadre', '=', 3)
        ->select('desarrollo_cursos.id')
        ->get();
    ...
    public function editactividad($id)
    {
        ...
        $curso_id = $desarrollo_curso->cursos_id; // Accede al id del curso
        return view('cliente.seccion8c.actividad',compact('desarrollo_actividad', 'curso_id'));
    }
    ...
    public function seguimiento8c($nombreVista, $CursoId)
    {
