...
class Seccion9iController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cliente.seccion9i.indexseccion9i')->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }

    public function create()
    {
        return view('cliente.seccion9i.createseccion9i');
    }
    ...
    public function show($cursoId)
    {
        ...
        return view('cliente.seccion9i.showseccion9i',['cursoId' => $cursoId])->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion9i.editseccion9i',compact('cierre_curso', 'curso_id'));
    }
    ...
    { 
        ...
        ->where('cierre_cursos.seccion_encuadre', '=', 9)
        ->select('cierre_cursos.id')
        ->get();
    ...
    public function editactividad($id)
    {
        ...
        $curso_id = $cierre_curso->cursos_id; // Accede al id del curso
        return view('cliente.seccion9i.actividad',compact('cierre_actividad', 'curso_id'));
    }
