...
class Seccion9kController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cliente.seccion9k.indexseccion9k')->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }

    public function create()
    {
        return view('cliente.seccion9k.createseccion9k');
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion9k.editseccion9k',compact('cierre_curso', 'curso_id'));
    }
    ...
    { 
        ...
        ->where('cierre_cursos.seccion_encuadre', '=', 11)
        ->select('cierre_cursos.id')
        ->get();
    ...
    public function editactividad($id)
    {
        ...
        $curso_id = $cierre_curso->cursos_id; // Accede al id del curso
        return view('cliente.seccion9k.actividad',compact('cierre_actividad', 'curso_id'));
    }
