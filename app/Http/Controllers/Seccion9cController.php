...
class Seccion9cController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cliente.seccion9c.indexseccion9c')->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }

    public function create()
    {
        return view('cliente.seccion9c.createseccion9c');
    }
    ...
    public function show($cursoId)
    {
        ...
        return view('cliente.seccion9c.showseccion9c',['cursoId' => $cursoId])->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion9c.editseccion9c',compact('cierre_curso', 'curso_id'));
    }
    ...
    { 
        ...
        ->where('cierre_cursos.seccion_encuadre', '=', 3)
        ->select('cierre_cursos.id')
        ->get();
    ...
    public function editactividad($id)
    {
        ...
        $curso_id = $cierre_curso->cursos_id; // Accede al id del curso
        return view('cliente.seccion9c.actividad',compact('cierre_actividad', 'curso_id'));
    }
