...
class Seccion9gController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cliente.seccion9g.indexseccion9g')->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }

    public function create()
    {
        return view('cliente.seccion9g.createseccion9g');
    }
    ...
    public function show($cursoId)
    {
        ...
        return view('cliente.seccion9g.showseccion9g',['cursoId' => $cursoId])->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion9g.editseccion9g',compact('cierre_curso', 'curso_id'));
    }
    ...
    { 
        ...
        ->where('cierre_cursos.seccion_encuadre', '=', 7)
        ->select('cierre_cursos.id')
        ->get();
    ...
    public function editactividad($id)
    {
        ...
        $curso_id = $cierre_curso->cursos_id; // Accede al id del curso
        return view('cliente.seccion9g.actividad',compact('cierre_actividad', 'curso_id'));
    }
