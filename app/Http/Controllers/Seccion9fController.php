...
class Seccion9fController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cliente.seccion9f.indexseccion9f')->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }

    public function create()
    {
        return view('cliente.seccion9f.createseccion9f');
    }
    ...
    public function show($cursoId)
    {
        ...
        return view('cliente.seccion9f.showseccion9f',['cursoId' => $cursoId])->with('cierre_actividades',$cierre_actividades)
        ->with('cierre_cursos',$cierre_cursos);
    }
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion9f.editseccion9f',compact('cierre_curso', 'curso_id'));
    }
    ...
    { 
        ...
        ->where('cierre_cursos.seccion_encuadre', '=', 6)
        ->select('cierre_cursos.id')
        ->get();
    ...
    public function editactividad($id)
    {
        ...
        $curso_id = $cierre_curso->cursos_id; // Accede al id del curso
        return view('cliente.seccion9f.actividad',compact('cierre_actividad', 'curso_id'));
    }
