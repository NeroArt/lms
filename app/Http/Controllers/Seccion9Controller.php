...
class Seccion9Controller extends Controller
{
    ...
    public function show($cursoId)
    {
        ...
        return view('cliente.seccion9a.showseccion9a')->with('cierre_actividades',$cierre_actividades)
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion9a.editseccion9a',compact('cierre_curso'));
    }
    ...
    public function editactividad($id)
    {
        ...
        return view('cliente.seccion9a.actividad',compact('cierre_actividad'));
    }
