...
class Seccion8bController extends Controller
{
    ...
    public function show($cursoId)
    {
        ...
        return view('cliente.seccion8b.showseccion8b')->with('desarrollo_actividades',$desarrollo_actividades)
    ...
    public function edit($id)
    {
        ...
        return view('cliente.seccion8b.editseccion8b',compact('desarrollo_curso'));
    }
    ...
    public function editactividad($id)
    {
        ...
        return view('cliente.seccion8b.actividad',compact('desarrollo_actividad'));
    }
